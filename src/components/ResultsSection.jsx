    ...
    <Reveal delay={i * 100}>
      <div
        ...
        style={{
          ...
          background: "#f8fcff",
          borderRight:
            i < total - 1 ? "1px solid rgba(17,4,41,0.08)" : "none",
        }}
      >
        <div
          style={{
        ...
        >
          {count}
          <span style={{ color: "#2096F3" }}>{s.suffix}</span>
        </div>
    ...
    <Reveal delay={delay} style={{ height: "100%" }}>
      <div
        ...
        style={{
          ...
          boxShadow: "0 10px 30px rgba(32,150,243,0.05)",
...
export default function ResultsSection() {
  ...
  return (
    <section style={{ background: "#fff", padding: "90px 20px 80px" }}>
      <div style={{ maxWidth: 1260, margin: "0 auto" }}>
          ...
          >
            ...
            <Reveal>
              <div
                style={{
                  padding: "30px 28px",
                  borderTop: "1px solid rgba(17,4,41,0.08)",
                  background: "#f8fcff",
                }}
              >
                <p
            ...
            <div style={{ position: "relative", height: 320 }}>
              ...
              <div
                style={{
                  ...
                  inset: 0,
                  background:
                    "linear-gradient(to bottom, transparent, rgba(17,4,41,0.6))",
                }}
              />
            </div>
          </div>
                ...
                {cases.map((c, i) => (
                  <div
                    ...
                    style={{
                      ...
                      borderRadius: 14,
                      background: "#ffffff",
                      border: "1px solid rgba(17,4,41,0.06)",
                    }}
                  >
                    <div>
                      <div style={{ fontWeight: 700, color: "#110429" }}>
                        {c.name}
                      </div>

                      <div style={{ fontSize: 12, color: "rgba(17,4,41,0.6)" }}>
                        {c.category}
                      </div>
                    </div>

                    <div style={{ fontWeight: 800, color: "#2096F3" }}>
                      {c.result}
                    </div>
                  </div>
                ))}
                  ...
                  <div key={i} style={{ display: "flex", gap: 14 }}>
                    <div
                      style={{
                        ...
                        border: "1px solid rgba(32,150,243,0.25)",
                        color: "#2096F3",
                        display: "flex",
                        alignItems: "center",
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: 12, color: "rgba(17,4,41,0.65)" }}>
                        {s.desc}
                      </div>
                    </div>
                  </div>
