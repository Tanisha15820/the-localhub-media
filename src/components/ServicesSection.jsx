  ...
  return (
    <div
      ...
      style={{
        ...
        transform: hovered ? "translateY(-6px) scale(1.02)" : "translateY(0)",
        boxShadow: hovered
          ? "0 20px 50px rgba(32,150,243,0.25)"
          : "0 4px 16px rgba(17,4,41,0.08)",
        ...
        <Reveal>
          <div
            ...
            style={{
              ...
              background: "#110429",
              color: "#fff",
              border: "1px solid rgba(32,150,243,0.12)",
              boxShadow: "0 20px 60px rgba(17,4,41,0.18)",
            }}
          >
            <div>
              <h2
              ...
              <button
                ...
                style={{
                  ...
                  cursor: "pointer",
                  fontWeight: 600,
                  boxShadow: "0 10px 24px rgba(32,150,243,0.28)",
                  transition: "all 0.3s ease",
                }}
              >
                Close
